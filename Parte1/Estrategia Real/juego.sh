...
archivo_seleccion1="seleccion1.txt"
...
while [ $ronda -le 50 ]; do
  # genera $archivo_cosecha1
	python3 Recoleccion/recoleccion.py "1" $archivo_ciudades $archivo_rutas $archivo_cosecha1 $archivo_imperio1

	# genera $archivo_cosecha2
	python3 Recoleccion/recoleccion.py "2" $archivo_ciudades $archivo_rutas $archivo_cosecha2 $archivo_imperio2
